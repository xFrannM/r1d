...
{	
	useAmpedWeapons = true //disable burn_mode by iskyfish.2016.10.13
...
function RocketPodsFire_SalvoRockets( titan, weapon, soul, results )
{
	...
	local fireRate 				= 1//weapon.GetWeaponModSetting( "fire_rate" ) * 0.01
