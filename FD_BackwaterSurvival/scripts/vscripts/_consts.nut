...
const BURN_CARD_MAP_LOOT_DROP = 0
...
const COOP_RESTARTS						= 0
const COOP_RESTARTS_MP_RISE 			= 0

const COOP_SENTRY_TURRET_MAX_COUNT_PET		= 1	// don't try to set it to more then 3
...
const TD_GENERATOR_HEALTH				= 20000.0
const TD_GENERATOR_SHIELD_HEALTH		= 1500.0
...
const COOP_TURRET_ACCURACY_MULTIPLIER	= 1.0	// 1.0 old
...
const ARC_TITAN_EMP_FIELD_RADIUS 			= 660
const ARC_TITAN_EMP_FIELD_RADIUS_SQR 		= 108900 //pow( 330, 2 )
const ARC_TITAN_EMP_FIELD_INNER_RADIUS 		= 300
...
enum eTitanBuildEvent
{
	invalid = -1,
	INIT,
	RESET_COMPLETE_CONDITION,
	GET_COMPLETE_CONDITION,
	START,
	STOP,
	REMAIN,
	END_CHECK,
	ADD_BUILD_ADVENTAGE,
	DECREMENT_BUILD_CONDITION,
	FORCE_BUILD_COMPLETE,
	ADD_BUILD_POINT,

	_count_
}

enum eTitanBuildRule
{
	invalid  	= -1,
	RULE_TIME,
	RULE_TIME_ATDM,
