...
const ORE_DISTANCE_SQUARED_FROM_DUMP_SPOT =  4500000 //UPDATE IF CHANGED: 6250000 = 2500 * 2500
const ORE_ROOF_DISTANCE_SQUARED_FROM_DUMP_SPOT =  4500000 //UPDATE IF CHANGED: 2250000 = 1500 * 1500
...
function DisplayOreNuggetOnMinimap( oreNugget, oreNuggetMaterial = "vgui/HUD/minimap_goal_friendly"  )
{
	...
	oreNugget.Minimap_SetObjectScale( 0.04 )
