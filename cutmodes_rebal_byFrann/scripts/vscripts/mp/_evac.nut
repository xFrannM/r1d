...
{
	level.dropshipArrivalWaitTime = time + 5
}
...
function EvacShipMain( health = EVAC_DROPSHIP_HEALTH, shield = EVAC_DROPSHIP_SHIELD_HEALTH )
{
	...
	dropshipSoul.SetShieldHealthMax( shieldValue )
	dropshipSoul.SetShieldHealth( shieldValue )
	...
	dropship.SetHealth( 30000 )
	dropship.SetMaxHealth( 30000 )
